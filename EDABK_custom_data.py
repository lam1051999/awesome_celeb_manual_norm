...
def main():
    ...
    check_path_exist(opt.intra_test_temp)

    with open(os.path.join(opt.intra_test_temp, 'train_label.json'), 'w') as outfile:
        json.dump(train_dict, outfile)

    
    with open(os.path.join(opt.intra_test_temp, 'test_label.json'), 'w') as outfile:
