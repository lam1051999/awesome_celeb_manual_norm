...
def main() -> None:
    ...
    move_files(opt.root, opt.replay_root, live_train[:opt.NUMBER_OF_LIVE_SAMPLES_TRAIN], "live train")
    move_files(opt.root, opt.replay_root, live_test[:opt.NUMBER_OF_LIVE_SAMPLES_TEST], "live test")
